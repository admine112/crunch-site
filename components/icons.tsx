// ✅ Временные заглушки для иконок до установки lucide-react
...
export const Home: React.FC<IconProps> = ({ className, ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const Heart: React.FC<IconProps> = ({ className, ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
